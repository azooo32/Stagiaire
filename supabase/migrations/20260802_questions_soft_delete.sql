-- Migration: Add soft delete support to questions table
-- Created at: 2026-08-02

-- 1. Add column is_deleted to public.questions
ALTER TABLE public.questions ADD COLUMN is_deleted BOOLEAN DEFAULT false;

-- 2. Recreate function set_questions_updated_at to include is_deleted check in trigger
...
begin
    if (old.question is distinct from new.question or
        ...
        old.audio_highlights is distinct from new.audio_highlights or
